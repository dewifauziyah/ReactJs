...
export default function Pagination(props) {
  ...
  return (
    <nav aria-label="Page navigation example py-10" className='flex justify-center '>
      <ul className="inline-flex items-center -space-x-px">
        <li>
          <a href="#" className="block py-2 px-3 ml-0 leading-tight text-black bg-white rounded-l-lg border border-gray-300 hover:bg-green-600 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <li>
          <a href="#" className="block py-2 px-3 leading-tight text-black bg-white rounded-r-lg border border-gray-300 hover:bg-green-600 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
